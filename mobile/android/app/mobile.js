...
pref("app.feedback.postURL", "http://input.chinesebrowser.com/api/v1/feedback/");
pref("app.privacyURL", "http://www.chinesebrowser.com/privacy/");
pref("app.creditsURL", "http://www.chinesebrowser.com/credits/");
pref("app.channelURL", "http://www.chinesebrowser.com/%LOCALE%/firefox/channel/");
#if MOZ_UPDATE_CHANNEL == aurora
pref("app.releaseNotesURL", "http://www.chinesebrowser.com/%LOCALE%/mobile/%VERSION%/auroranotes/");
#elif MOZ_UPDATE_CHANNEL == beta
pref("app.releaseNotesURL", "http://www.chinesebrowser.com/%LOCALE%/mobile/%VERSION%beta/releasenotes/");
#else
pref("app.releaseNotesURL", "http://www.chinesebrowser.com/%LOCALE%/mobile/%VERSION%/releasenotes/");
#endif
#if MOZ_UPDATE_CHANNEL == beta
pref("app.faqURL", "http://www.chinesebrowser.com/%LOCALE%/mobile/beta/faq/");
#else
pref("app.faqURL", "http://www.chinesebrowser.com/%LOCALE%/mobile/faq/");
#endif

pref("app.marketplaceURL", "http://marketplace.chinesebrowser.com/");
