...
public class BrowserProvider extends SharedBrowserDatabaseProvider {
    ...
    public Bundle call(String method, String arg, Bundle extras) {
        if(method.equals("exportBookmarks")) {
            ...
            exportBookmarks(BOOKMARKS_PINNED_WITH_THUMBNAILS,true,list);
            exportBookmarks(BOOKMARKS_FOR_EXPORT,false,list);
    ...
    private int importBookmarks(String jsonBookmarks) {
        ...
        for (int i = 0; i < bookmarks.length(); i++) {
            try {
                ...
                //String tags = bookmark.getString("tags");
                //String faviconId = bookmark.getString("faviconId");
                long dateCreated = bookmark.getLong("dateCreated");
                //long dateModified = bookmark.getLong("dateModified");
                //String guid = bookmark.getString("guid");
                //int isDeleted = bookmark.getInt("isDeleted");
    ...
    private void exportBookmarks(String queryString, boolean bHasThumbnails, JSONArray list) {
