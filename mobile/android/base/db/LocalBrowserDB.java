    ...
    public int addDistributionBookmarks(ContentResolver cr, Distribution distribution, int offset) {
        ...
        for (int i = 0; i < bookmarks.length(); i++) {
            try {
                ...
                final ContentValues bookmarkValue = createBookmark(now, title, url, position, parent);
                bookmarkValues.add(bookmarkValue);
                ...
                if (bookmark.has("icon")) {
                    ...
                    try {
                        ...
                        //long thumbnailId = db.insertOrThrow(Thumbnails.TABLE_THUMBNAILS, null, v);
...
//                }
    ...
    public Cursor getTopSites(ContentResolver cr, int minLimit, int maxLimit) {
        ...
        return new TopSitesCursorWrapper(pinnedSites, null, null, minLimit);
    }
}
